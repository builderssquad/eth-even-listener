...
// sync service
const { startSyncService } = require('../listener.js');

// init a key-value storage db (can be any), here is in example the data is stored in memory, but you can chose different storage
...
const config = {
    ...
    // required: init an event's handler. if you callback error, it will try to send it again till success
